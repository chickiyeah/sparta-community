...
<TouchableOpacity style={styles.middleButtonAll} onPress={()=>{navigation.reset({index: 0, routes:[{name:'kakaoLogin'}]}),global.selpage = 'quiz'}}><Text style={styles.middleButtonTextAll}>즉문즉답</Text></TouchableOpacity>
